...
if( ! class_exists( 'Home_Advantage_Section' ) ) {
    class Home_Advantage_Section extends Element_Section {
        ...
        private function get_tabs() {
            ...
            return sprintf( '<div class="slider"><div class="slick">%s</div>%s</div>', 
                                    $items, $buttons );
        }
        ...
        private function get_tab( $row ) {
            ...
            return sprintf( '<div class="slide"><div class="background"%s></div><div class="entry-content">%s%s</div></div>', 
                            $style,
                            $title,
                            $text
                         );
