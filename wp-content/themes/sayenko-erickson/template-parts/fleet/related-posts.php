...
if( ! class_exists( 'Related_Posts' ) ) {
    class Related_Posts extends Element_Section {
        ...
        public function __construct() {
            ...
            $fields = get_field( 'related_posts' );            
        ...
        public function render() {
            ...
            $heading = __( 'You might also be interested in', '_s' );
            $heading = _s_format_string( $heading, 'h2' );
            $description = wpautop( 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.' ); 
        ...
        private function _s_get_related_posts_query_args( $args = array() ) {
            ...
            $category_ids = $this->get_fields( 'categories' );
