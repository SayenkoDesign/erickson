...
_s_get_template_part( 'template-parts/video-gallery', 'hero' );
?>
            ...
            <main id="main" class="site-main" role="main">
                ...
                if ( have_posts() ) : 
                    ...
                    printf( '<ul class="menu facetwp-filters"><li>%s</li><li><button class="button" onclick="FWP.reset()">%s</button></li></ul>', 
                        facetwp_display( 'facet', 'video_gallery_service' ),
                        __( 'reset' )
                     );
                    ...
                    while ( have_posts() ) :
                        ...
                        _s_get_template_part( 'template-parts', 'content-video-column' );
